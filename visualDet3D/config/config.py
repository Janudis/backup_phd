...
## path
path = edict()
path.data_path = "/home/dimitris/PhD/PhD/nuscenes/nusc_kitti/train_val" # used in visualDet3D/data/.../dataset
...
data = edict(
    ...
    # rgb_shape = (900, 1600, 3), # ORIGINAL NUSCENES
    # rgb_shape = (450, 800, 3), # /2 23/10
    rgb_shape = (512, 512, 3),
    #rgb_shape = (360, 640, 3), # /2.5
    # rgb_shape = (691, 1649), # SAME ASPECT RATIO WITH KITTI
    ...
    train_split_file = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'finetune_split', 'train.txt'),
    val_split_file   = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'finetune_split', 'val.txt')
)
