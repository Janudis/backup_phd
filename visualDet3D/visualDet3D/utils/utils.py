...
def cfg_from_file(cfg_filename:str)->EasyDict:
    ...
    with tempfile.TemporaryDirectory() as temp_config_dir:
        ...
        # shutil.copy(cfg_filename, os.path.join(temp_config_dir, temp_config_name) + '.py')
        shutil.copyfile(cfg_filename, os.path.join(temp_config_dir, temp_config_name) + '.py')
